...
<div class="wrap">
	...
	<input type="submit" id="nm_top_save_forms" class="button-primary" value="<?php _e( 'Save Forms', 'nm_forms' ); ?>" />
	<input type="submit" id="toggle_settings" class="button" value="<?php _e( 'Toggle Settings', 'nm_forms' ); ?>" />
			...
			?>
				...
				<div class="nm_form" data-nm_form_id="<?=$form['nm_form_id'];?>">
					...
					<div class="nm_form_heading">
						<h3><?=$form['nm_form_title'];?><span class="nm_form_delete">x</span><span class="nm_form_add">Add field</span></h3> 
					</div>
					...
					<ul class="menu nm_menu nm_sortable  ui-sortable"> 
						<li class="nm_item menu-item menu-item-page">
							...
							<div class="nm_field_settings nm_form_settings" style="display:none;">
	...
	<input type="submit" id="nm_save_forms" class="button-primary" value="<?php _e( 'Save Forms', 'nm_forms' ); ?>" />
