...
class Plugin_Core
{
	...
	public function __construct()
	{
		...
		$this->license     = MOLONGUI_AUTHORSHIP_LICENSE;
	...
	private function define_admin_hooks()
	{
		...
		if( MOLONGUI_AUTHORSHIP_LICENSE != 'premium' && MOLONGUI_AUTHORSHIP_UPGRADABLE == 'yes' ) $this->loader->add_action( 'admin_notices', $plugin_admin, 'display_go_premium_notice' );
