...
<div class="molongui-about-wrap">
	...
	<h1 class="brand">Molongui
		<span class="by"><?php _e('by', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ); ?> <a href="http://www.amitzy.com/" target="_blank" title="Amitzy"><?php _e('Amitzy', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ); ?></a></span>
	</h1>
	...
	<ul class="about">
		<li>
			<table class="status-table widefat" cellspacing="0">
				...
				<tr>
					...
					<td><?php echo ucfirst(MOLONGUI_AUTHORSHIP_LICENSE) ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<?php printf( __( '%1$sMolongui%2$s', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ),
						              '<a href="http://molongui.amitzy.com" target="_blank">',
						              '</a>'
						); ?>
					</td>
				...
				<tr>
					<?php if ( MOLONGUI_AUTHORSHIP_LICENSE != 'premium' && MOLONGUI_AUTHORSHIP_UPGRADABLE == 'yes' ) : ?>
		...
		<li>
			<table class="rate-table widefat" cellspacing="0">
				<thead>
				<tr>
					<th colspan="3" data-export-label="Plugin Feedback"><?php ( MOLONGUI_AUTHORSHIP_LICENSE != 'premium' ? _e('Rate', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ) : _e( 'Feedback', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ) ); ?></th>
				</tr>
				</thead>
				<tbody>
				<tr>
					<td rowspan="5">
						...
						<?php if ( MOLONGUI_AUTHORSHIP_LICENSE != 'premium' ) : ?>
							...
							<br>
							<a href="https://wordpress.org/support/view/plugin-reviews/<?php echo MOLONGUI_AUTHORSHIP_SLUG ?>" class="button button-primary" target="_blank">
	...
	echo '<p>';
		printf( __( 'Molongui is a trademark of %1$s Amitzy%2$s.', MOLONGUI_AUTHORSHIP_TEXT_DOMAIN ),
		        '<a href="http://www.amitzy.com" target="_blank">',
		        '</a>'
		);
	echo '</p>';
